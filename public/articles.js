...
localStorage.setItem("articles", JSON.stringify(articlesMain));
localStorage.setItem("tags", JSON.stringify(tagsMain));
localStorage.setItem("users", JSON.stringify(usersMain));
...
let articlesModule = (function () {
    ...
    function hideArticle(id) {
        let tempArticles = JSON.parse(localStorage.getItem("articles"));
        let article = tempArticles.find(function (element) {
            return element.id == id;
        });
        if (article != undefined) {
            article.isHidden = true;
        }
        localStorage.setItem("articles", JSON.stringify(tempArticles));
